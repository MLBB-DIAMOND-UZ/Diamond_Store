...
function displayItems() {
  ...
  var starlight = document.getElementById("starlight");

  const diamondData = foodItem.filter((item) => item.category == "diamonds");
  const promoData = foodItem.filter((item) => item.category == "promo");
  const weeklyData = foodItem.filter((item) => item.category == "weekly");
  const twilightData = foodItem.filter((item) => item.category == "twilight");
  const starlightData = foodItem.filter((item) => item.category == "starlight");
  ...
  diamondData.map((item) => {
    ...
    diamond.setAttribute("class", "fa fa-diamond");
    diamond.setAttribute("id", "rating");

    var heart = document.createElement("i");
    heart.setAttribute("class", "fa fa-heart-o add-to-cart");
    heart.setAttribute("id", item.id);

    cardTop.appendChild(diamond);
  ...
  weeklyData.map((item) => {
    ...
    weekly.appendChild(itemCard);
  });

  twilightData.map((item) => {
    var itemCard = document.createElement("div");
    itemCard.setAttribute("id", "item-card");
  ...
  starlightData.map((item) => {
    ...
    starlight.appendChild(itemCard);
  });
}
displayItems();
...
document.getElementById("add-nickname").addEventListener("click", addNickname);

document
  .getElementById("m-add-nickname")
  .addEventListener("click", addNickname);

function addNickname() {
  var nickname = prompt("Enter your nickname", "");
  if (nickname) {
    document.getElementById("add-nickname").innerText = " " + nickname;
  } else {
    alert("Nickname not added");
  }
}
